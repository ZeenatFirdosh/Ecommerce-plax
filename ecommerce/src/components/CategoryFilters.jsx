...
const sortOptions = [
  ...
  { name: 'Price: Low to High',value:'price-asc', href: '#', current: false },
  { name: 'Price: High to Low',value:'price-desc', href: '#', current: false },
  { name: 'Best Rating',value:'rating-desc', href: '#', current: false },
  ...
  const handleSort = (criteria) => {
    ...
    console.log(products,"category");
      ...
      if (criteria === 'price-asc') {
        toSortArray.sort((a, b) =>a.discountedPrice - b.discountedPrice);
      } else if (criteria === 'price-desc') {
        toSortArray.sort((a, b) => b.discountedPrice - a.discountedPrice);
      } else if (criteria === 'rating-asc') {
        toSortArray.sort((a, b) => a.rating - b.rating);
      } else if (criteria === 'rating-desc') {
        toSortArray.sort((a, b) => b.rating - a.rating);
